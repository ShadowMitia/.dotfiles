...
(use-package eglot
  ...
  ;;'(
  ;;clang              ((python-mode python-ts-mode) . ("ruff" "--quiet" "--stdin-filename=stdin" "-"))
  ;;((c-mode c-ts-mode c++-mode c++-ts-mode) . ("clangd" "-background-index" "-log=error" "--header-insertion=never"))
  ;;))
...
;; TODO: conflict with multiple-cursors
(use-package corfu
...
;; run all-the-icons-install-fonts the first time!
...
TODO: more modes?
TODO: could use some more shebang alternatives
